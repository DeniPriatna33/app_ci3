...
<script>
	...
	$(document).ready(function() {
		// var table = $('#dataTable').DataTable({
			...
			// 	serverSide: true,
			// 	ajax: {
			// 		url: "<?= base_url('crud/Crud_serverside_v1/ajax_list') ?>",
			// 		type: "POST"
			// 	},
			// 	columns: [{
			// 			data: "0"
	...
	function edit_data(id) {
		...
		$.ajax({
			url: "<?= base_url('crud/Crud_serverside_v1/ajax_edit/') ?>/" + id,
			type: "GET",
			dataType: "JSON",
	...
	function save() {
		var url;
		if (save_method == 'add') {
			url = "<?= base_url('crud/Crud_serverside_v1/ajax_add') ?>";
		} else {
			url = "<?= base_url('crud/Crud_serverside_v1/ajax_update') ?>";
		}
	...
	function delete_data(id) {
		if (confirm('Are you sure to delete this data?')) {
			...
			$.ajax({
				url: "<?= base_url('crud/Crud_serverside_v1/ajax_delete') ?>/" + id,
				type: "POST",
				dataType: "JSON",
				success: function(data) {
